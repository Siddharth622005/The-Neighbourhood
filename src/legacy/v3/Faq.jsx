  ...
  return (
    <div className="border-t border-warm-taupe/15 last:border-b">
      ...
      >
        ...
        <span
          className={`material-symbols-outlined text-warm-taupe shrink-0 transition-transform duration-300 ${
            open ? "rotate-45" : ""
          }`}
          aria-hidden="true"
        >
      ...
      >
        <div className="overflow-hidden">
          <p className="v3-body-lg text-on-surface-variant max-w-[42rem] pb-7">{item.a}</p>
        </div>
      </div>
    </div>
  );
