    ...
    <section id="story" className="py-section-gap md:py-32 px-margin-mobile md:px-gutter max-w-container-max mx-auto">
      <div className="max-w-[42rem] mx-auto">
          ...
          <WordReveal
            ...
            className="v3-h2 text-charcoal mb-10 max-w-[36rem]"
          />

          <div
            ref={story.ref}
            className={`v3-fade ${story.inView ? "in-view" : ""} space-y-6 v3-body-lg text-on-surface-variant max-w-[36rem]`}
          >
            <p>
          ...
          <blockquote
            ref={quote.ref}
            className={`v3-fade ${quote.inView ? "in-view" : ""} mt-12 border-l-2 border-soft-sand pl-8 max-w-[36rem]`}
          >
