...
function Truth({ truth }) {
  ...
  return (
    ...
    >
      ...
      <p className="md:col-span-6 v3-body-lg text-on-surface-variant max-w-[36rem]">
        {truth.body}
      </p>
    </div>
  );
...
export default function TheQuestion() {
  ...
  return (
    ...
    >
      <div className="max-w-[48rem] mb-16 md:mb-20">
        ...
        />
        <p className="v3-body-lg text-on-surface-variant mt-6 max-w-[42rem]">
      ...
      <div
        ref={closing.ref}
        className={`v3-fade ${closing.inView ? "in-view" : ""} border-t border-warm-taupe/15 pt-14 md:pt-16 max-w-[48rem]`}
      >
