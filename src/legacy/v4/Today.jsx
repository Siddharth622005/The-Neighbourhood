  ...
  return (
    ...
    >
      <div className={flipped ? "md:order-2" : ""}>
        ...
        <h3 className="v3-h2 text-charcoal mb-5 max-w-[28rem]">{pillar.title}</h3>
        <p className="v3-body-lg text-on-surface-variant max-w-[32rem]">{pillar.body}</p>
      </div>
...
export default function Today() {
  return (
    ...
    >
      <div className="max-w-[48rem] mb-20 md:mb-24">
